...
> **Download:** [CostCue v1.0.2](https://github.com/linqichenggg/CostCue/releases/latest) from the official GitHub Releases page.
...
- **148 built-in products** — Choose familiar services such as ChatGPT, Claude, Gemini, Apple Music, Netflix, Notion, and iCloud+, with icons available offline.
